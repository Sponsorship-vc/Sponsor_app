...
function Profilecard() {
  ...
  return (
    <div className='flex  h-[30rem] w-[65rem]  ml-[17rem] rounded-xl flex-col bg-white '>
        ...
        <div className='mt-[4rem]'>
          ...
          <div className='flex flex-col'>
              ...
              <div className='flex flex-row gap-4 mt-3'>
                ...
                <p className='font-bold text-dark-blue'>9562784981</p>
              </div>             
          </div>
          <div className='flex flex-col'>
              ...
              <div className='flex flex-row gap-4 mt-3'>
                ...
                <p className='font-bold text-dark-blue'>i.dheerajdileep@gmail.com</p>
              </div>          
          </div>
          <div className='flex flex-col'>
              <label className='text-[#A098AE]'>Date of birth</label>
              <div className='flex flex-row gap-4 mt-3'>
                <p className='font-bold text-dark-blue'>25/12/2002</p>
              </div>             
          </div>
          <div className='flex flex-col'>
              <label className='text-[#A098AE]'>Address</label>
              <div className='flex flex-row gap-4 mt-3'>
                <p className='font-bold text-dark-blue'>Peringayil , p.o chittissery, pulakkartukara, Kerala</p>
              </div>             
          </div>
      </div>
        ...
        <div className='flex flex-col ml-5 gap-y-10 mt-5'>
          ...
          <div className='flex flex-row gap-[30rem]'>
              <div className='flex flex-col'>
                ...
                <div className='flex flex-row gap-4 mt-3'>
                  <p className='font-bold text-dark-blue'></p>
                </div>             
              </div>
              <div className='flex flex-col'>
                <label className='text-[#A098AE]'>Interest</label>
                <div className='flex flex-row gap-4 mt-3'>
                  <p className='font-bold text-dark-blue'>Web3,Blockchain</p>
                </div>             
              </div>
          </div>
        </div>
