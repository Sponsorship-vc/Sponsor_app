    ...
    <div className='flex flex-col justify-center items-center bg-[#C2E5FF] min-h-screen'>
       <div className="flex items-center justify-center flex-col w-full px-4">
            ...
            <form className="w-full max-w-lg mx-auto flex flex-col">
              <input type='email' placeholder='Enter your email address' className='w-full mb-6 px-4 py-2 focus:outline-none rounded-lg'/>
              <textarea placeholder="Type your message" className="w-full mb-6 px-4 py-2 focus:outline-none rounded-lg resize-none h-48 placeholder-top"/>
              <button className='bg-dark-blue text-white w-full py-3 rounded-lg'>Mail Us</button>
            </form>
